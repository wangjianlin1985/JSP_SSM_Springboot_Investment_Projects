...
<%
    ...
    String newsType = (String)request.getAttribute("newsType"); //信息类别查询关键字
			...
			<div class="col-md-3 bottom15" <%=clearLeft %>>
			  <a  href="<%=basePath  %>News/<%=news.getNewsId() %>/frontshow"><img class="img-responsive" src="<%=basePath%><%=news.getNewsPhoto()%>" /></a>
			     <div class="showFields">
			     	...
			     	<div class="field">
	            		信息类别:<%=news.getNewsType() %>
			     	</div>
			     	<div class="field">
	            		标题:<%=news.getTitle() %>
			     	</div>
			     	<div class="field">
	            		发布时间:<%=news.getPublishDate() %>
			     	</div>
	...
	<div class="col-md-3 wow fadeInRight">
		...
		<form name="newsQueryForm" id="newsQueryForm" action="<%=basePath %>News/frontlist" class="mar_t15" method="post">
			<div class="form-group">
				<label for="newsType">信息类别:</label>
				<input type="text" id="newsType" name="newsType" value="<%=newsType %>" class="form-control" placeholder="请输入信息类别">
			</div>
			<div class="form-group">
  ...
  <div class="modal-dialog" style="width:900px;" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body" style="height:450px; overflow: scroll;">
		  ...
		  <div class="form-group">
		  	 <label for="news_newsType_edit" class="col-md-3 text-right">信息类别:</label>
		  	 <div class="col-md-9">
			    <input type="text" id="news_newsType_edit" name="news.newsType" class="form-control" placeholder="请输入信息类别">
			 </div>
		  </div>
		  <div class="form-group">
		  ...
		  <div class="form-group">
		  	 <label for="news_content_edit" class="col-md-3 text-right">内容:</label>
		  	 <div class="col-md-9">
...
<script>
//实例化编辑器
var news_content_edit = UE.getEditor('news_content_edit'); //内容编辑器
	...
	$.ajax({
		...
		success : function (news, response, status) {
			if (news) {
				...
				$("#news_newsType_edit").val(news.newsType);
