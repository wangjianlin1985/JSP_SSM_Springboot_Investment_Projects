...
<nav class="navbar navbar-default navbar-fixed-top">
    <div class="container">
        ...
        <div class="navbar-header">
            ...
            <a href="<%=basePath %>index.jsp" class="navbar-brand">企业招商网</a>
        </div>
        <!--小屏幕导航按钮和logo-->
        <!--导航-->
        <div class="navbar-collapse collapse">
            <ul class="nav navbar-nav navbar-left">
                ...
                <li><a href="<%=basePath %>Company/frontlist">企业查询</a></li>
                <!-- <li><a href="<%=basePath %>Baoming/frontlist">项目报名</a></li> -->
                <li><a href="<%=basePath %>Hangye/frontlist">行业查询</a></li>
                <li><a href="<%=basePath %>Project/frontlist">招商项目</a></li>
             ...
             <ul class="nav navbar-nav navbar-right">
             	<%
				    ...
				    if(user_name==null){
	  			%> 
	  			<li><a href="<%=basePath %>Company/company_frontAdd.jsp"><i class="fa fa-sign-in"></i>&nbsp;&nbsp;注册</a></li>
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu" aria-labelledby="dLabel">
                        ...
                        <li><a href="<%=basePath %>Project/project_frontCompanyAdd.jsp"><span class="glyphicon glyphicon-heart"></span>&nbsp;&nbsp;发布招商项目</a></li>
                        <li><a href="<%=basePath %>Project/companyFrontlist"><span class="glyphicon glyphicon-credit-card"></span>&nbsp;&nbsp;我发布的招商项目</a></li>
                        <li><a href="<%=basePath %>Baoming/companyFrontlist"><span class="glyphicon glyphicon-user"></span>&nbsp;&nbsp;我报名的项目</a></li>
                        <li><a href="<%=basePath %>Leaveword/leaveword_frontCompanyAdd.jsp"><span class="glyphicon glyphicon-cog"></span>&nbsp;&nbsp;发布留言</a></li>
                        <li><a href="<%=basePath %>Leaveword/companyFrontlist"><span class="glyphicon glyphicon-heart"></span>&nbsp;&nbsp;我的留言</a></li>
                        <li><a href="<%=basePath %>Company/company_frontSelfModify.jsp"><span class="glyphicon glyphicon-credit-card"></span>&nbsp;&nbsp;修改个人资料</a></li>
                    </ul>
                </li>
