		       ...
		       text: "企业管理",
			       ...
			       children:
			    	   [{
			    		    ...
			    		    url: "Company/company_add.jsp"
			    	   	},
			    		{
			    	   		text: "企业管理",
			    	   		state: "open",
			    	   		iconCls: "icon-manager",
			    	   		url: "Company/company_query_result.jsp"
			    	    }
			    	   ]
			},{
		       text: "行业管理",
			       ...
			       children:
			    	   [{
			    		    ...
			    		    state: "open",
			    		    iconCls: "icon-add-new",
			    		    url: "Hangye/hangye_add.jsp"
			    	   	},
			    		{
			    	   		text: "行业管理",
			    	   		state: "open",
			    	   		iconCls: "icon-manager",
			    	   		url: "Hangye/hangye_query_result.jsp"
			    	    }
			    	   ]
			},{
		       text: "招商项目管理",
		       ...
		       text: "项目报名管理",
			       ...
			       children:
			    	   [{
			    		    ...
			    		    state: "open",
			    		    iconCls: "icon-add-new",
			    		    url: "Baoming/baoming_add.jsp"
			    	   	},
			    		{
			    	   		text: "项目报名管理",
			    	   		state: "open",
			    	   		iconCls: "icon-manager",
			    	   		url: "Baoming/baoming_query_result.jsp"
			    	    }
			    	   ]
			},{
		       text: "新闻信息管理",
