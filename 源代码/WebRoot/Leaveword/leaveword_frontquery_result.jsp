...
<jsp:include page="../header.jsp"></jsp:include>
				    		...
				    		<div class="row">
				    			<div class="col-md-12 top5">
				    				...
				    				<table class="table table-condensed table-hover">
				    					<tr class="success bold"><td>序号</td><td>留言标题</td><td>留言单位</td><td>留言时间</td><td>管理回复</td><td>回复时间</td><td>操作</td></tr>
				    					<% 
				    						/*计算起始序号*/
 										...
 										<tr>
 											...
 											<td><%=leaveword.getCompanyObj().getCompanyName() %></td>
	...
	<div class="col-md-3 wow fadeInRight">
		...
		<form name="leavewordQueryForm" id="leavewordQueryForm" action="<%=basePath %>Leaveword/frontlist" class="mar_t15" method="post">
            ...
            <div class="form-group">
            	<label for="companyObj_companyUserName">留言单位：</label>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body" style="height:450px; overflow: scroll;">
		  ...
		  <div class="form-group">
		  	 <label for="leaveword_companyObj_companyUserName_edit" class="col-md-3 text-right">留言单位:</label>
		  	 <div class="col-md-9">
			    <select id="leaveword_companyObj_companyUserName_edit" name="leaveword.companyObj.companyUserName" class="form-control">
			    </select>
		  	 </div>
		  </div>
		  <div class="form-group">
			...
			if (leaveword) {
				...
				$.ajax({
					...
					success: function(companys,response,status) { 
						$("#leaveword_companyObj_companyUserName_edit").empty();
						var html="";
		        		$(companys).each(function(i,company){
		        			html += "<option value='" + company.companyUserName + "'>" + company.companyName + "</option>";
		        		});
		        		$("#leaveword_companyObj_companyUserName_edit").html(html);
		        		$("#leaveword_companyObj_companyUserName_edit").val(leaveword.companyObjPri);
					}
				});
