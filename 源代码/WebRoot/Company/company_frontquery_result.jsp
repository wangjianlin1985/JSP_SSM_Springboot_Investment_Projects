...
<%
    ...
    String companyUserName = (String)request.getAttribute("companyUserName"); //企业用户名查询关键字
			...
			<div class="col-md-3 bottom15" <%=clearLeft %>>
			  <a  href="<%=basePath  %>Company/<%=company.getCompanyUserName() %>/frontshow"><img class="img-responsive" src="<%=basePath%><%=company.getYyzz()%>" /></a>
			     <div class="showFields">
			     	...
			     	<div class="field">
	            		公司行业:<%=company.getHangyeObj().getHangyeName() %>
			     	</div>
			     	<div class="field">
	            		联系人:<%=company.getLxr() %>
			     	</div>
	...
	<div class="col-md-3 wow fadeInRight">
		...
		<form name="companyQueryForm" id="companyQueryForm" action="<%=basePath %>Company/frontlist" class="mar_t15" method="post">
			<div class="form-group">
				<label for="companyUserName">企业用户名:</label>
				<input type="text" id="companyUserName" name="companyUserName" value="<%=companyUserName %>" class="form-control" placeholder="请输入企业用户名">
			</div>
			<div class="form-group">
            ...
            <div class="form-group">
            	<label for="hangyeObj_hangyeId">公司行业：</label>
			...
			<div class="form-group">
				...
				<input type="text" id="regTime" name="regTime" class="form-control"  placeholder="请选择注册时间" value="<%=regTime %>" onclick="SelectDate(this,'yyyy-MM-dd')" />
			</div>
  ...
  <div class="modal-dialog" style="width:900px;" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body" style="height:450px; overflow: scroll;">
		  ...
		  <div class="form-group">
		  	 <label for="company_hangyeObj_hangyeId_edit" class="col-md-3 text-right">公司行业:</label>
		  	 <div class="col-md-9">
			    <select id="company_hangyeObj_hangyeId_edit" name="company.hangyeObj.hangyeId" class="form-control">
			    </select>
		  	 </div>
		  </div>
		  <div class="form-group">
		  ...
		  <div class="form-group">
		  	 <label for="company_regTime_edit" class="col-md-3 text-right">注册时间:</label>
		  	 <div class="col-md-9">
                <div class="input-group date company_regTime_edit col-md-12" data-link-field="company_regTime_edit">
                    <input class="form-control" id="company_regTime_edit" name="company.regTime" size="16" type="text" value="" placeholder="请选择注册时间" readonly>
			...
			if (company) {
				...
				$.ajax({
					...
					success: function(hangyes,response,status) { 
						$("#company_hangyeObj_hangyeId_edit").empty();
						var html="";
		        		$(hangyes).each(function(i,hangye){
		        			html += "<option value='" + hangye.hangyeId + "'>" + hangye.hangyeName + "</option>";
		        		});
		        		$("#company_hangyeObj_hangyeId_edit").html(html);
		        		$("#company_hangyeObj_hangyeId_edit").val(company.hangyeObjPri);
					}
				});
				...
				$("#company_regTime_edit").val(company.regTime);
...
$(function(){
    ...
    /*注册时间组件*/
    $('.company_regTime_edit').datetimepicker({
    	language:  'zh-CN',  //语言
