...
public class LeavewordService {
    ...
    /*按照查询条件分页查询留言记录*/
    public ArrayList<Leaveword> queryLeaveword(String leaveTitle,Company companyObj,String leaveTime,int currentPage) throws Exception { 
     	String where = "where 1=1";
    	if(!leaveTitle.equals("")) where = where + " and t_leaveword.leaveTitle like '%" + leaveTitle + "%'";
    	if(null != companyObj &&  companyObj.getCompanyUserName() != null  && !companyObj.getCompanyUserName().equals(""))  where += " and t_leaveword.companyObj='" + companyObj.getCompanyUserName() + "'";
    ...
    /*按照查询条件查询所有记录*/
    public ArrayList<Leaveword> queryLeaveword(String leaveTitle,Company companyObj,String leaveTime) throws Exception  { 
     	String where = "where 1=1";
    	if(!leaveTitle.equals("")) where = where + " and t_leaveword.leaveTitle like '%" + leaveTitle + "%'";
    	if(null != companyObj &&  companyObj.getCompanyUserName() != null && !companyObj.getCompanyUserName().equals(""))  where += " and t_leaveword.companyObj='" + companyObj.getCompanyUserName() + "'";
    	if(!leaveTime.equals("")) where = where + " and t_leaveword.leaveTime like '%" + leaveTime + "%'";
    ...
    /*当前查询条件下计算总的页数和记录数*/
    public void queryTotalPageAndRecordNumber(String leaveTitle,Company companyObj,String leaveTime) throws Exception {
     	String where = "where 1=1";
    	if(!leaveTitle.equals("")) where = where + " and t_leaveword.leaveTitle like '%" + leaveTitle + "%'";
    	if(null != companyObj &&  companyObj.getCompanyUserName() != null && !companyObj.getCompanyUserName().equals(""))  where += " and t_leaveword.companyObj='" + companyObj.getCompanyUserName() + "'";
    	if(!leaveTime.equals("")) where = where + " and t_leaveword.leaveTime like '%" + leaveTime + "%'";
